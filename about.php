    ...
    <div id="wrapper">
        ...
        <div class="no-bottom no-top zebra" id="content">
                ...
                <div class="container">
                    <div class="row g-5">
                        ...
                        <div class="col-lg-6 wow fadeInRight" data-wow-delay=".25s">
                            ...
                            customers. With a commitment to quality, convenience, and customer satisfaction, we strive
                            to make every rental experience a seamless and enjoyable one. We understand that every
                            customer has unique needs and preferences when it comes to renting a car. That's why we
                            maintain a diverse fleet of well-maintained vehicles to cater to various requirements. From
                            compact cars for solo travelers to spacious SUVs for families, we have a wide range of
            ...
            <section id="section-img-with-tab">
                ...
                <div class="image-container col-md-6 pull-right" data-bgimage="url(images/background/6.jpg) center">
                </div>
            </section>
